...
{
    [CreateAssetMenu(fileName = "New Ability", menuName = "Create a New Ability/CrystalAbility", order = 1)]
    public class CrystalAbility : Ability
    {
        ...
        public override void UseAbility()
        {
            ...
            else
            {
                ...
                playerAttacker.HandleAOE("Crystal");
            }
        }
