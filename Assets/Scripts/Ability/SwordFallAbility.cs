...
{
    [CreateAssetMenu(fileName = "New Ability", menuName = "Create a New Ability/SwordFallAbility", order = 1)]
    public class SwordFallAbility : Ability
    {
        ...
        public override void UseAbility()
        {
            ...
            else
            {
                ...
                playerAttacker.HandleAOE("SwordFall");
            }
        }
