...
{
    [CreateAssetMenu(fileName = "New Ability", menuName = "Create a New Ability/TankSwordAbility", order = 1)]
    public class TankSwordAbility : Ability
    {
        ...
        public override void UseAbility()
        {
            ...
            else
            {
                ...
                playerAttacker.HandleGainEffects("TankSword");
            }
        }
